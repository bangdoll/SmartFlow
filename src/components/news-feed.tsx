            ...
            {tag && (
                <div className="mb-6 p-4 bg-blue-50/50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30 backdrop-blur-sm">
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            href="/"
                            className="text-sm px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-200 dark:hover:border-blue-800 transition-colors shadow-sm"
                        >
                            清除篩選 ✕
                        </Link>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm">
                        顯示關於 "{tag}" 的精選新聞 ({filteredItems.length} 則)
                    </p>
                </div>
            )}
