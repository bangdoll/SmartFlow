...
export function BookmarkCard({ item }: BookmarkCardProps) {
    ...
    const handleCardClick = (e: React.MouseEvent) => {
        // If clicking on a link or button, don't trigger card navigation
    ...
    return (
        <article
            ...
            className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 group flex flex-col h-full cursor-pointer"
        >
